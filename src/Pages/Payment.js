...
function Payment() {
  ...
  return (
    ...
    <>
        <div className="card mx-auto" style={{marginTop: 10 + 'em', width: "50%"}}>
            ...
            <div className="card-body">
                ...
                <div className="form-group">
                    ...
                    <MDBBtn color='dark' style={{borderRadius: "4px", width: "100%", margin: "0", marginBottom:"5px"}}>Debit or Credit Card</MDBBtn>
